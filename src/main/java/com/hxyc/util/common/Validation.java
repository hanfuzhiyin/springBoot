/*
 * @(#)Validation.java    Created on 2019年9月5日
...
/**
 * @author huangzy
 * @version $Revision: 1.0 $, $Date: 2019年9月5日 下午7:33:47 $
 */
public class Validation {
     ...
     * 用户名6-12位 首字母+数字字母组成
     */
    public static final String USER_NAME = "^[A-Za-z][A-Za-z0-9]{5,11}$";
