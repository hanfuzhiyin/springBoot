/*
 * @(#)TransactionAdviceConfig.java    Created on 2019年9月3日
...
/**
 * @author huangzy
 * @version $Revision: 1.0 $, $Date: 2019年9月3日 下午5:58:12 $
 */
@Aspect
...
public class TransactionAdviceConfig {
     ...
     * 定义切点路径
     */
    private static final String AOP_POINTCUT_EXPRESSION = "execution(* com.hxyc.service.*.*(..))";
    @Autowired
    ...
    public TransactionInterceptor TxAdvice() {
        ...
        txMap.put("register*", transactionAttribute1);
