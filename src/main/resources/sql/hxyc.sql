...
CREATE TABLE `hxyc_user` (
  ...
  `status` int(1) NOT NULL DEFAULT '1' COMMENT '-1 未激活 0无效 1正常 2冻结 3彻底封锁',
  `createtime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `publickey` varchar(3000) NOT NULL COMMENT '安全码公',
  `privatekey` varchar(3000) DEFAULT NULL COMMENT '''安全码私',
  `salt` varchar(32) DEFAULT NULL COMMENT '激活code',
